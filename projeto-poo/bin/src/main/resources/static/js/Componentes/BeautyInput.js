...
class BeautyInput extends HTMLElement{
    ...
    connectedCallback(){
        ...
        let beautyInput = this.buildBeautyInput(id, this.type, this.title, this.placeholder, this.required, this.icon);
     ...
     */
    buildBeautyInput(id, type, title, placeholder, required, iconClass){
    ...
    setInputMask(inputId, maskType){
        ...
        pageController.addEventHandler()
    }
